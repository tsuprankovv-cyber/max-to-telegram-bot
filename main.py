...
logger.info("=" * 80)
logger.info("🚀 MAX → TG FORWARDER [FINAL COMPLETE]")
...
async def handle(msg):
    ...
    logger.info(f"✅ [DONE] MID: {mid} | processed: {len(_processed_mids)}/20")
